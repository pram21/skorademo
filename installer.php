...
class DUPX_Bootstrap
{
	...
	const ARCHIVE_FILENAME	 = '20210913_skora_f2ff163d4659fc3a5642_20210929153351_archive.zip';
	const ARCHIVE_SIZE		 = '325454466';
	const INSTALLER_DIR_NAME = 'dup-installer';
	const PACKAGE_HASH		 = 'f2ff163-29153351';
    const SECONDARY_PACKAGE_HASH = '9bcc20b-29153351';
	const VERSION			 = '1.4.3';
